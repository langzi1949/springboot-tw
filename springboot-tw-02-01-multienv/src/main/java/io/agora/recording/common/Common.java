...
public class Common{
  ...
  public enum VIDEO_FORMAT_TYPE {
     ...
     * <ul>
     *   <li>Individual Mode ({@link RecordingConfig#isMixingEnabled isMixingEnabled} is set as false): MPEG-4 video and JPEG files are supported. </li>
     *   <li>Composite Mode ({@link RecordingConfig#isMixingEnabled isMixingEnabled} is set as true): MPEG-4 video files for combined streams and JPEG files for individual streams are supported. </li>
     * </ul>
     */
